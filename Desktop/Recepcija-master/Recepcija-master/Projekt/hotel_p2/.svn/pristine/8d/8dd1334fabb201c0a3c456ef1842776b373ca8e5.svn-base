...
import org.datacontract.schemas._2004._07.CistilniServis_EntitiesW.Narocilo;
import org.datacontract.schemas._2004._07.P8_StoritvePrevozovP.NarocenPrevoz;
import org.datacontract.schemas._2004._07.wellness_storitveW.Storitev;
import org.tempuriPrevozi.IStoritvePrevozovService;
import org.tempuriPrevozi.StoritvePrevozovService;
...
public class Zagonski {
	...
	public static void main(String [] args){
		try {
			...
			RecepcijaService rex=new RecepcijaServiceLocator();
			RecepcijaWS r=rex.getRecepcijaPort();
			Oseba o=new Oseba();
			o.setIme("Test");
			o.setPriimek("Test");
			o.setDatum_rojstva("01.05.1975");
			o.setDavcna_st(44445678);
			o.setEmso("561111111111");
			o.setStarost(42);
			...
			//System.out.println(r.odjaviSobo(2));
            ...
            case "1":  System.out.println(r.dodeliSobo(osebe, 0)); //VNESI OSEBO in REZERVACIJSKO ŠTEVILKO (èe obstaja, drugaèe je 0)
                     	break;
            case "2":  System.out.println(r.odjaviSobo(2)); //VNESI ŠT SOBE
                     	break;
