	...
	public static void main(String [] args){
		try {
	       ...
	       String s = br.readLine();
	        switch (s) {
	        case "0":	System.out.println("Vnesi rezervacijsko številko");
            ...
            case "5":  Storitev[] storitve=wellness.wellness_VrniWellnessStoritve();		
						...
						break;
            case "6":   System.out.println("Vnesi EMŠO");
						emso=br.readLine();
            			...
            			break;
            case "7":  	System.out.println("Vnesi EMŠO");
						emso=br.readLine();
            			Pranje p=hotelska_pralnica.narociCiscenje(emso, "1516730400000"); 
            			r.dodajNaRacun(new BigDecimal(30), emso, "Èišèenje" , "23.01.2018", "ciscenje");
			            Calendar calendar = Calendar.getInstance();
			            calendar.setTimeInMillis(Long.parseLong(p.getKonecPranja()));
            			System.out.println("Konec èišèenja: "+calendar.getTime()); 
			            break;
            case "8":  	System.out.println("Kakšno vrsto dogodak išèete?");
						...
						break;
            case "9":  System.out.println("Vnesi EMŠO");
						emso=br.readLine();
						System.out.println("Vnesi stevilko storitve");
						storitev=br.readLine();
            			...
            			break;
            case "10":  System.out.println("Vnesi EMŠO");
						emso=br.readLine();
						System.out.println("Vnesi želeno lokacijo");
						storitev=br.readLine();
