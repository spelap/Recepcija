...
public class Test {
	...
	public static void main(String[] args) {
		...
		//System.out.println(r.dodajNaRacun(new BigDecimal(10), "111111111111", "likanje hlaè", "08.01.2018", "222"));
		...
		for (Gost g: gosti){
			System.out.println("Emšo gosta: "+g.getEmso());
		}
		ArrayList<Soba> sobe=r.vrniVseSobe();
		for (Soba s: sobe){
			System.out.println("Št sobe: "+s.getSt_sobe());
		}*/
