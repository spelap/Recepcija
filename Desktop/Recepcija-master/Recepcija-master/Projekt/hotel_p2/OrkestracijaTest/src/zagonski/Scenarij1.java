...
public class Scenarij1 {
	...
	String emso="";
		try {
			...
			System.out.println("Trenutno imamo prostih še "+r.sporociSteviloProstihSob()+" sob.");
			...
			System.out.println("Trenutno naša služba za animacijske dogodke ne deluje. Se opravièujemo.");
