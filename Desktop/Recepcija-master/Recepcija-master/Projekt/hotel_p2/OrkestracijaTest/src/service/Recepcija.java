		...
		try{
			...
			Response odg = iBuilder.get();
				...
				try {
					...
					//byte[] out = "{\"Datum\":\"\\/Date(2515159062000+0100)\\/\",\"Id\":4,\"IdProstora\":42,\"Opis\":\"Po tepihu je polito rdeèe vino!\",\"Opravljeno\":true,\"Preklicano\":false}" .getBytes(StandardCharsets.UTF_8);
