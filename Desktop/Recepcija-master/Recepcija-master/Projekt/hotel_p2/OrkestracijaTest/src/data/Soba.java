...
public class Soba {
	private int st_sobe;
	private String stanje_sobe;
	private int st_postelj;
	private String rang_kakovosti;
	private Double cena;
	...
	public String getStanje_sobe() {
		return stanje_sobe;
	}
	public void setStanje_sobe(String stanje_sobe) {
	...
	public String getRang_kakovosti() {
		return rang_kakovosti;
	}
	public void setRang_kakovosti(String rang_kakovosti) {
