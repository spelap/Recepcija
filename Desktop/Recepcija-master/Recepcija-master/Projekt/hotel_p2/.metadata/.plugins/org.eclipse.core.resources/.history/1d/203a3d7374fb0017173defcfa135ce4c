...
public class RecepcijaServiceLocator extends org.apache.axis.client.Service implements service.RecepcijaService {
    ...
    private java.lang.String RecepcijaPort_address = "http://soa.informatika.uni-mb.si:8080/Recepcija_v4/Recepcija";
    ...
    public service.RecepcijaWS getRecepcijaPort() throws javax.xml.rpc.ServiceException {
    ...
    public service.RecepcijaWS getRecepcijaPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.RecepcijaServiceSoapBindingStub _stub = new service.RecepcijaServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.RecepcijaWS.class.isAssignableFrom(serviceEndpointInterface)) {
                service.RecepcijaServiceSoapBindingStub _stub = new service.RecepcijaServiceSoapBindingStub(new java.net.URL(RecepcijaPort_address), this);
                _stub.setPortName(getRecepcijaPortWSDDServiceName());
                return _stub;
            }
        }
